...
class EditAnswerForm extends React.Component {
    ...
    saveEntity = () => {
        ...
        if (this.props.maybeAnswer !== null) {
            ...
            axios.post("/api/updateAnswer", payload).then(this.afterAnswerUpdated);
        } else {
            axios.post("/api/createAnswer", payload).then(this.afterAnswerUpdated)
        }
    };
    ...
    render = () => {
        ...
        const saveAnswerButtonText = this.props.maybeAnswer !== null ? 'Update answer' : 'Create answer';
